...
::set EnginePath_4=C:\DEVELOPMENT\ENGINES\UE_4.27
set EnginePath=C:\DEV\UE\ENGINES\UE_5.3
...
set COPYRIGHT_LINE=// SnakeGame. Copyright Elin Denis. All Rights Reserved.
